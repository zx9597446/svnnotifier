...
namespace CHD.SVN_Notifier
{
	...
	{
		public static Version Version = new Version ("1.9.4");
		public static string VersionStatus = " beta";		// " alpha", " beta", ""
		...
		private void InitializeComponent()
		{
			...
			this.label2.Text = "Copyright (C) 2007-2011 Computer Hardware Design Ltd";
